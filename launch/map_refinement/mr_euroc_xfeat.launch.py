"""Map refinement on EuRoC with the 64-dim XFeat vocab."""
import os
...
def generate_launch_description():
    ...
    return LaunchDescription([
        DeclareLaunchArgument('config_path',
            default_value=os.path.join(pkg_share, 'configs', 'map_refinement', 'mr_euroc_xfeat.yaml')),
        DeclareLaunchArgument('map_root', default_value='/tmp/airslam_xfeat_mh03'),
