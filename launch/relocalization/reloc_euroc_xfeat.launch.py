"""Single-image relocalization on EuRoC against an XFeat-points-only
refined map (no lines).
"""
import os
...
def generate_launch_description():
    ...
    return LaunchDescription([
        DeclareLaunchArgument('config_path',
            default_value=os.path.join(pkg_share, 'configs', 'relocalization', 'reloc_euroc_xfeat.yaml')),
        ...
        DeclareLaunchArgument('map_root', default_value='/tmp/airslam_xfeat_pointsonly'),
        ...
        DeclareLaunchArgument('traj_path',
            default_value='/tmp/airslam_xfeat_pointsonly/reloc.txt'),
