"""Visual odometry on EuRoC stereo+IMU sequences."""
import os
...
def generate_launch_description():
    ...
    return LaunchDescription([
        DeclareLaunchArgument('config_path',
            default_value=os.path.join(pkg_share, 'configs', 'visual_odometry', 'vo_euroc.yaml')),
        DeclareLaunchArgument('dataroot', default_value='/media/data/datasets/euroc/seq/V1_02_medium'),
