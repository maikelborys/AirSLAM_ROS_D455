...
namespace {
// Helper: ROS 2 timestamps as rclcpp::Time from a seconds-as-double.
inline rclcpp::Time TimeFromSeconds(double t){
...
RosPublisher::RosPublisher(const RosPublisherConfig& ros_publisher_config,
    ...
    : _config(ros_publisher_config), _nh(nh){

  if(_config.feature){
    _ros_feature_pub = _nh->create_publisher<sensor_msgs::msg::Image>(_config.feature_topic, 10);
    std::function<void(const FeatureMessgaeConstPtr&)> publish_feature_function =
      ...
      ros_feature_msg->header.stamp = TimeFromSeconds(feature_message->time);
  ...
  if(_config.frame_pose){
    _ros_frame_pose_pub = _nh->create_publisher<geometry_msgs::msg::PoseStamped>(_config.frame_pose_topic, 10);
    _pub_latest_odometry = _nh->create_publisher<nav_msgs::msg::Odometry>(_config.frame_odometry_topic, 1000);
    _tf_broadcaster = std::make_unique<tf2_ros::TransformBroadcaster>(_nh);
    ...
    std::function<void(const FramePoseMessageConstPtr&)> publish_frame_pose_function =
      ...
      pose_stamped.header.stamp = TimeFromSeconds(frame_pose_message->time);
      ...
      odometry.header.stamp = pose_stamped.header.stamp;
      ...
      // tf2_ros: build TransformStamped directly (no tf::Transform / tf::Quaternion).
      geometry_msgs::msg::TransformStamped transform_stamped;
      transform_stamped.header.stamp = pose_stamped.header.stamp;
      transform_stamped.header.frame_id = "map";
      transform_stamped.child_frame_id = "camera";
      transform_stamped.transform.translation.x = frame_pose_message->pose(0, 3);
      transform_stamped.transform.translation.y = frame_pose_message->pose(1, 3);
      transform_stamped.transform.translation.z = frame_pose_message->pose(2, 3);
  ...
  if(_config.keyframe){
    _ros_keyframe_pub = _nh->create_publisher<geometry_msgs::msg::PoseArray>(_config.keyframe_topic, 10);
    _ros_keyframe_array.header.frame_id = "map";

    _ros_path_pub = _nh->create_publisher<nav_msgs::msg::Path>(_config.path_topic, 10);
    ...
    std::function<void(const KeyframeMessageConstPtr&)> publish_keyframe_function =
      ...
      _ros_keyframe_array.header.stamp = TimeFromSeconds(keyframe_message->time);
      _ros_path.header.stamp = _ros_keyframe_array.header.stamp;

      std::map<int, int>::iterator it;
      for(int i = 0; i < (int)keyframe_message->ids.size(); i++){
        ...
        geometry_msgs::msg::PoseStamped pose_stamped;
        pose_stamped.header.stamp = TimeFromSeconds(keyframe_message->times[i]);
  ...
  if(_config.map){
    // for mappoints
    _ros_map_pub = _nh->create_publisher<sensor_msgs::msg::PointCloud>(_config.map_topic, 1);
    _ros_mappoints.header.stamp = _nh->now();
    ...
    std::function<void(const MapMessageConstPtr&)> publish_map_function =
      ...
      _ros_mappoints.header.stamp = TimeFromSeconds(map_message->time);

      std::unordered_map<int, int>::iterator it;
      for(int i = 0; i < (int)map_message->ids.size(); i++){
    ...
    // for maplines
    _ros_mapline_pub = _nh->create_publisher<visualization_msgs::msg::Marker>(_config.mapline_topic, 1);
    _ros_maplines.header.stamp = _nh->now();
    ...
    std::function<void(const MapLineMessageConstPtr&)> publish_mapline_function =
      ...
      _ros_maplines.header.stamp = TimeFromSeconds(mapline_message->time);

      std::unordered_map<int, int>::iterator it;
      for(int i = 0; i < (int)mapline_message->ids.size(); i++){
  ...
  if(_config.reloc){
    ...
    _ros_reloc_traj_pub = _nh->create_publisher<visualization_msgs::msg::Marker>(_config.reloc_topic+"/trajectory", 1);
    _ros_reloc_traj.header.stamp = _nh->now();
    ...
    // for current pose
    _ros_reloc_pose_pub = _nh->create_publisher<geometry_msgs::msg::PoseStamped>(_config.reloc_topic+"/pose", 10);
    std::function<void(const RelocMessageConstPtr&)> publish_reloc_pose_function =
        [&](const RelocMessageConstPtr& reloc_message){
      int idx = reloc_message->times.size() - 1;
      geometry_msgs::msg::PoseStamped pose_stamped;
      pose_stamped.header.stamp = TimeFromSeconds(reloc_message->times[idx]);
      pose_stamped.header.frame_id = "map";
    ...
    // for matches
    _ros_reloc_mpts_pub = _nh->create_publisher<visualization_msgs::msg::Marker>(_config.reloc_topic+"/matches", 1);
    std::function<void(const RelocMessageConstPtr&)> publish_reloc_mpts_function =
        [&](const RelocMessageConstPtr& reloc_message){
      int idx = reloc_message->times.size() - 1;
      visualization_msgs::msg::Marker ros_reloc_mpts;
      ros_reloc_mpts.header.stamp = TimeFromSeconds(reloc_message->times[idx]);
      ...
      for(int i = 0; i < (int)reloc_message->mappoints.size(); i++){
